            ...
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text("fone_conv", $convenio->fone_conv ,["class"=>"form-control mmss","required"=>"required"]) !!}
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        {!! Form::text("contato_conv", $convenio->contato_conv ,["class"=>"form-control mmss","required"=>"required"]) !!}
                    </div>
